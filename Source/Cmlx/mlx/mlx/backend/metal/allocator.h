...
class MetalAllocator : public allocator::Allocator {
 ...
 public:
  ...
  /// Create a Buffer wrapping externally-owned mmap'd memory via Metal's
  /// newBufferWithBytesNoCopy. The buffer is NOT added to the buffer cache
  /// or residency set. The caller (MmapFileReader) owns the memory lifetime.
 ...
 private:
  ...
  // Track mmap-backed buffers to prevent cache/free
